...
public class SearchCourier extends AppCompatActivity implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.child("Couriers").addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                expListAdapter = new ExpListAdapter(SearchCourier.this,parentList);
